...
const
  ...
  g_sVersion = 'D0C3641FA053A0C32F344FC7EADF5DF9ABABBC28C73FEB4D';  //2.00 Build 20081231
  g_sUpDateTime = '8076DE13F2070953D2CA60CF32F6DA5D'; //2008/12/31
          ...
          if HumDataDB.count > 0 then begin
            for I:= 0 to HumDataDB.count -1 do begin
              if HumDataDB.Get(I, ChrRecord) >= 0 then begin
                if ChrRecord.Header.boDeleted then Continue;//继续
