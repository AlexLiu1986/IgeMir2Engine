...
begin
  ...
  LoadHumDB(Form1.Hum_db1.Text , m_MainHumLists);
...
//打开从库数据文件  20071122
  f_HumH  := FileOpen(Form1.Hum_db1.text, 0);
  f_MirH  := FileOpen(Form1.Mir_db1.text, 0);
////////////////////////////////////////////////////////////////
//20071120增加
...
//////////////////////////////////////////////////////////////////
  ...
  m_nCurMax  := GetFileSize({sRoot + '\DBServer\FDB\Hum.db'}Form1.Hum_db1.text, Sizeof(TDBHeader1), Sizeof(TDBHum)); //FileSeek(f_HumH, Sizeof(TDBFileHeader), 2) div Sizeof(DBHum);
