...
type
  TfrmItemSet = class(TForm)
    ...
    RadioHumUse: TRadioButton;
    RadioHeroUse: TRadioButton;
    RadioHumHeroUse: TRadioButton;
    ...
    procedure RadioHumHeroUseClick(Sender: TObject);
...
begin
  ...
  case g_Config.nIsUseZhuLi of //斗笠可带选项 20080417
    0: RadioHumHeroUse.Checked:=True;
    1: RadioHumUse.Checked:=True;
    2: RadioHeroUse.Checked:=True;
  end;
...
{$IF SoftVersion <> VERDEMO}
  ...
  Config.WriteInteger('Setup', 'IsUseZhuLi', g_Config.nIsUseZhuLi);//斗笠可带选项 20080417
...
//斗笠可带选项 20080417
procedure TfrmItemSet.RadioHumHeroUseClick(Sender: TObject);
begin
  if not boOpened then Exit;
  if RadioHumHeroUse.Checked then g_Config.nIsUseZhuLi := 0;
  if RadioHumUse.Checked then g_Config.nIsUseZhuLi := 1;
  if RadioHeroUse.Checked then g_Config.nIsUseZhuLi := 2;
  ModValue();
end;
