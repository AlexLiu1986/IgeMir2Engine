...
type
  TfrmFunctionConfig = class(TForm)
    ...
    Label149: TLabel;
    Label150: TLabel;
    EditMaxDragonPoint: TSpinEdit;
    EditAddDragonPoint: TSpinEdit;
    EditDecDragonPoint: TSpinEdit;
    ...
    procedure EditMaxDragonPointChange(Sender: TObject);
    procedure EditAddDragonPointChange(Sender: TObject);
...
//黄条气槽 20080201
 { EditMaxDragonPoint.Value := g_Config.nMaxDragonPoint; //20080619 注释
  EditAddDragonPoint.Value := g_Config.nAddDragonPoint;
  EditDecDragonPoint.Value := g_Config.nDecDragonPoint;}
...
//黄条气槽 20080201
  ...
  {Config.WriteInteger('Setup', 'MaxDragonPoint', g_Config.nMaxDragonPoint); //20080619 注释
  Config.WriteInteger('Setup', 'AddDragonPoint', g_Config.nAddDragonPoint);
  Config.WriteInteger('Setup', 'DecDragonPoint', g_Config.nDecDragonPoint); }
...
//黄条气槽 20080201
procedure TfrmFunctionConfig.EditMaxDragonPointChange(Sender: TObject);
begin
{  if not boOpened then Exit; //20080619 注释
  g_Config.nMaxDragonPoint := EditMaxDragonPoint.Value;
  ModValue();}
end;

procedure TfrmFunctionConfig.EditAddDragonPointChange(Sender: TObject);
begin
{  if not boOpened then Exit; //20080619 注释
  g_Config.nAddDragonPoint := EditAddDragonPoint.Value;
  ModValue();  }
end;
...
begin
{  if not boOpened then Exit; //20080619 注释
  g_Config.nDecDragonPoint := EditDecDragonPoint.Value;
  ModValue(); }
end;
//龙影剑法威力 20080213
...
begin
  //TabSheet49.TabVisible:=False;//隐藏内功技能页 20081007
end;
