...
resourcestring
  sDBHeaderDesc = '清客网络数据库文件 2007/11/14';
  sDBIdxHeaderDesc = '清客网络数据库索引文件 2007/11/14';
type
...
begin
  if FileSeek(m_nFileHandle, SizeOf(TAccountDBRecord) * nIndex + SizeOf(TDBHeader), 0) <> -1 then begin
    ...
    if DBRecord.Header.boDeleted then begin //20080816 增加
       Result := False;
       Exit;
    end;
...
begin
  ...
  if FileSeek(m_nFileHandle, nPosion, 0) = nPosion then begin
    ...
    //DBRecord.Header.boDeleted := False;//20080816 注释
...
/////////////////////////////
(*
MainOutMessage('************m_Header属性值**************'+#13#10+
               '      m_Header.sDesc:'+m_Header.sDesc+#13#10+
               '      m_Header.n23:'+inttostr(m_Header.n23)+#13#10+
               '      m_Header.n28:'+inttostr(m_Header.n28)+ #13#10+
               '      m_Header.n2C:'+inttostr(m_Header.n2C)+ #13#10+
               '      m_Header.n30:'+inttostr(m_Header.n30)+ #13#10+
               '      m_Header.n34:'+inttostr(m_Header.n34)+ #13#10+
               '      m_Header.n38:'+inttostr(m_Header.n38)+ #13#10+
               '      m_Header.n3C:'+inttostr(m_Header.n3C)+#13#10+
               '      m_Header.n40:'+inttostr(m_Header.n40)+ #13#10+
               '      m_Header.n44:'+inttostr(m_Header.n44)+ #13#10+
               '      m_Header.n48:'+inttostr(m_Header.n48)+ #13#10+
               '      m_Header.n4B:'+inttostr(m_Header.n4B)+  #13#10+
               '      m_Header.n4C:'+inttostr(m_Header.n4C)+ #13#10+
               '      m_Header.n50:'+inttostr(m_Header.n50)+#13#10+
               '      m_Header.n54:'+inttostr(m_Header.n54)+ #13#10+
               '      m_Header.n58:'+inttostr(m_Header.n58)+ #13#10+
               '      m_Header.nLastIndex:'+inttostr(m_Header.nLastIndex)+ #13#10+
               '      m_Header.nIDCount:'+inttostr(m_Header.nIDCount)+#13#10+
               '      m_Header.n6C:'+inttostr(m_Header.n6C)+#13#10+
               '      m_Header.nDeletedIdx:'+inttostr(m_Header.nDeletedIdx)+#13#10+
               '      m_Header.dLastDate:'+datetimetostr(m_Header.dLastDate)+#13#10+
               '      m_Header.dUpdateDate:'+datetimetostr(m_Header.dUpdateDate));
                                        *)
(*MainOutMessage(
'**********TAccountDBRecord.Header********' +#13#10+
                 '   DBRecord.Header.boDeleted:'+inttostr(integer(DBRecord.Header.boDeleted))+
                 '   bt1:'+inttostr(integer(DBRecord.Header.bt1))+
                 '   bt2:'+inttostr(integer(DBRecord.Header.bt2))+
                 '   bt3:'+inttostr(integer(DBRecord.Header.bt3))+
                 '   CreateDate:'+datetimetostr(DBRecord.Header.CreateDate)+
                 '   UpdateDate:'+datetimetostr(DBRecord.Header.UpdateDate)+
                 '   sAccount:'+DBRecord.Header.sAccount+#13#10+
                 '**********TAccountDBRecord.UserEntry********' +#13#10+
                 '   账号:'+DBRecord.UserEntry.sAccount+
                 '   密码:'+DBRecord.UserEntry.sPassword+
                 '   用户名:'+DBRecord.UserEntry.sUserName+
                 '   身份证:'+DBRecord.UserEntry.sSSNo+
                 '   ID.UserEntry.sPhone:'+DBRecord.UserEntry.sPhone+
                 '   ID.UserEntry.sQuiz:'+DBRecord.UserEntry.sQuiz+
                 '   ID.UserEntry.sAnswer:'+DBRecord.UserEntry.sAnswer+
                 '   邮箱:'+DBRecord.UserEntry.sEMail+#13#10+
                 '**********TAccountDBRecord.UserEntryAdd********' +#13#10+
                 '   ID.UserEntryAdd.sQuiz2:'+DBRecord.UserEntryAdd.sQuiz2+
                 '   ID.UserEntryAdd.sAnswer2:'+DBRecord.UserEntryAdd.sAnswer2+
                 '   ID.UserEntryAdd.sBirthDay:'+DBRecord.UserEntryAdd.sBirthDay+
                 '   ID.UserEntryAdd.sMobilePhone:'+DBRecord.UserEntryAdd.sMobilePhone+
                 '   ID.UserEntryAdd.sMemo:'+DBRecord.UserEntryAdd.sMemo+
                 '   ID.UserEntryAdd.sMemo2:'+DBRecord.UserEntryAdd.sMemo2+#13#10+
                 '**********TAccountDBRecord.nErrorCount********' +#13#10+
                 '   ID.nErrorCount:'+inttostr(DBRecord.nErrorCount)+#13#10+
                 '**********TAccountDBRecord.dwActionTick********' +#13#10+
                 '   ID.dwActionTick:'+inttostr(DBRecord.dwActionTick));     *)
/////////////////////////////
...
function TFileIDDB.Count: Integer;
begin
