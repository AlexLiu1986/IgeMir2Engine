...
begin
  if boEnterKey then begin
    ...
    try
      ...
      sEnterKey := StrPas(MakeRegisterInfo(btUserMode * m_nCheckCode div 1003, PChar(sUserCode), wCount, wPersonCount, PChar(sUserName), RzDateTimeEditRegister.Date + Time));
