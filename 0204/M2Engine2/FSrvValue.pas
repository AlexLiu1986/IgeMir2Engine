...
procedure TFrmServerValue.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action := caFree;
end;

procedure TFrmServerValue.FormDestroy(Sender: TObject);
begin
  FrmServerValue:= nil;
end;
