...
var
  ...
  Config: pTConfig;
resourcestring
  sExceptionMsg = '{异常} TFrmIdSoc::DecodeSocStr';
begin
  Config := @g_Config;
...
var
  ...
  sPayMode: string;
resourcestring
  sExceptionMsg = '{异常} TFrmIdSoc::GetPasswdSuccess';
begin
  try
...
resourcestring
  sExceptionMsg = '{异常} TFrmIdSoc::GetCancelAdmission';
begin
  try
...
var
  ...
  SessInfo: pTSessInfo;
resourcestring
  sExceptionMsg = '{异常} FrmIdSoc::DelSession %d';
begin
  try
    sAccount := '';
    m_SessionList.Lock;
...
var
  ...
  sAccount: string;
resourcestring
  sExceptionMsg = '{异常} FrmIdSoc::GetCancelAdmissionA';
begin
  try
