...
begin
  ...
  PlayObject.CompareSuitItem(False);//套装与身上装备对比 20080729
...
procedure TfrmViewLevel.FormDestroy(Sender: TObject);
begin
  frmViewLevel:= nil;
end;

procedure TfrmViewLevel.FormClose(Sender: TObject;
