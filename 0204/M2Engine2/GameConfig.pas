...
type
  ...
  TfrmGameConfig = class(TForm)
    ...
    Label148: TLabel;
    SpinEditLimitMinOrderLevel: TSpinEdit;
    Label14: TLabel;
    GroupBox79: TGroupBox;
    Label156: TLabel;
    Label157: TLabel;
    LabelSayMsgFColor: TLabel;
    LabelSayMsgBColor: TLabel;
    EditSayMsgFColor: TSpinEdit;
    EditSayeMsgBColor: TSpinEdit;
    GroupBox80: TGroupBox;
    CheckBoxSaveExpRate: TCheckBox;
    Label158: TLabel;
    EditMakeGhostPlayMosterTime: TSpinEdit;
    Label159: TLabel;
    GroupBox81: TGroupBox;
    CheckBoxGMShowMsg: TCheckBox;
    GroupBox77: TGroupBox;
    Label149: TLabel;
    EditKillHumanWeaponUnlockRate: TSpinEdit;
    CheckBoxRecordClientMsg: TCheckBox;
    ...
    procedure ButtonAssistantSaveClick(Sender: TObject);
    procedure RadioButtonSdoAssistantClick(Sender: TObject);
    procedure EditSayMsgFColorChange(Sender: TObject);
    procedure EditSayeMsgBColorChange(Sender: TObject);
    procedure CheckBoxSaveExpRateClick(Sender: TObject);
    procedure EditMakeGhostPlayMosterTimeChange(Sender: TObject);
    procedure CheckBoxGMShowMsgClick(Sender: TObject);
    procedure EditKillHumanWeaponUnlockRateChange(Sender: TObject);
    procedure CheckBoxRecordClientMsgClick(Sender: TObject);
...
begin
  ...
  CheckBoxSaveExpRate.Checked := g_Config.boSaveExpRate;//是否保存双倍经验时间 20080412
  ...
  *)
  ...
  EditKillHumanWeaponUnlockRate.Value := g_Config.nKillHumanWeaponUnlockRate;
  ...
  CheckBoxGMShowMsg.Checked := g_Config.boGMShowFailMsg;//GM命令错误是否提示 20080602
  CheckBoxRecordClientMsg.Checked := g_Config.boRecordClientMsg;//记录人物私聊，行会聊天信息 20081213
  ...
  EditShowCastleWarEndMsgTime.Value := g_Config.dwShowCastleWarEndMsgTime div 60000{(60 * 1000)};
  EditCastleWarTime.Value := g_Config.dwCastleWarTime div 60000{(60 * 1000)};
  EditGetCastleTime.Value := g_Config.dwGetCastleTime div 60000{(60 * 1000)};
  EditGuildWarTime.Value := g_Config.dwGuildWarTime div 60000{(60 * 1000)};
  EditMakeGhostTime.Value := g_Config.dwMakeGhostTime div 1000;
  EditMakeGhostPlayMosterTime.Value := g_Config.dwMakeGhostPlayMosterTime div 1000;//人形怪尸体清理时间 20080418
  EditClearDropOnFloorItemTime.Value := g_Config.dwClearDropOnFloorItemTime div 1000;
  EditSaveHumanRcdTime.Value := g_Config.dwSaveHumanRcdTime div 60000{(60 * 1000)};
  EditHumanFreeDelayTime.Value := g_Config.dwHumanFreeDelayTime div 60000{(60 * 1000)};
  ...
  EditSayMsgFColor.Value := g_Config.btSayMsgFColor; //前景  千里传音 20080309
  EditSayeMsgBColor.Value := g_Config. btSayeMsgBColor;//背景 千里传音 20080309
 ...
 // SpinEditLimitMinOrderLevel.Value := g_Config.nLimitMinOrderLevel; //20080220

  //内挂
  (*CheckBoxShowRedHPLable.Checked := g_Config.ClientConf.boShowRedHPLable;
  CheckBoxShowGroupMember.Checked := g_Config.ClientConf.boShowGroupMember;
  CheckBoxShowAllItem.Checked := g_Config.ClientConf.boShowAllItem;
  CheckBoxShowBlueMpLable.Checked := g_Config.ClientConf.boShowBlueMpLable;
  CheckBoxShowName.Checked := g_Config.ClientConf.boShowName;
  CheckBoxAutoPuckUpItem.Checked := g_Config.ClientConf.boAutoPuckUpItem;
  CheckBoxShowHPNumber.Checked := g_Config.ClientConf.boShowHPNumber;
  CheckBoxShowAllName.Checked := g_Config.ClientConf.boShowAllName;
  CheckBoxForceNotViewFog.Checked := g_Config.ClientConf.boForceNotViewFog;
  CheckBoxParalyCan.Checked := g_Config.ClientConf.boParalyCan;
  CheckBoxMoveSlow.Checked := g_Config.ClientConf.boMoveSlow;
  CheckBoxCanStartRun.Checked := g_Config.ClientConf.boCanStartRun;
  CheckBoxAutoMagic.Checked := g_Config.ClientConf.boAutoMagic;
  CheckBoxMoveRedShow.Checked := g_Config.ClientConf.boMoveRedShow;
  CheckBoxMagicLock.Checked := g_Config.ClientConf.boMagicLock;
  SpinEditMoveTime.Value := g_Config.ClientConf.nMoveTime;
  SpinEditHitTime.Value := g_Config.ClientConf.nHitTime;
  SpinEditSpellTime.Value := g_Config.ClientConf.nSpellTime;
  case g_Config.ClientConf.nClientWgInfo of
    1,2: RadioButtonSdoAssistant.Checked := True;
    //2: RadioButtonGameAssistant.Checked := True;//20080714 注释
    3: RadioButtonNilAssistant.Checked := True;
  end;         *)
...
begin
  ...
  if (SoftVersionDate < 0) {or (SoftVersionDate > High(Integer))} then begin//20080522
...
{$IF SoftVersion <> VERDEMO}
  ...
  Config.WriteBool('Setup', 'RecordClientMsg', g_Config.boRecordClientMsg);//记录人物私聊，行会聊天信息 20081213
...
begin
  ...
  Config.WriteBool('Exp', 'SaveExpRate', g_Config.boSaveExpRate);//是否保存双倍经验时间 20080412
...
{$IF SoftVersion <> VERDEMO}
  ...
  Config.WriteBool('Setup', 'GMShowFailMsg', g_Config.boGMShowFailMsg);//GM命令错误是否提示 20080602
{$IFEND}
  uModValue();
end;
...
begin
  ...
  if not boOpened then Exit;
  g_Config.dwShowCastleWarEndMsgTime := EditShowCastleWarEndMsgTime.Value * 60000{(60 * 1000)};
  ModValue();
end;
...
begin
  ...
  if not boOpened then Exit;
  g_Config.dwCastleWarTime := EditCastleWarTime.Value * 60000{(60 * 1000)};
  ModValue();
end;
...
begin
  ...
  if not boOpened then Exit;
  g_Config.dwGetCastleTime := EditGetCastleTime.Value * 60000{(60 * 1000)};
  ModValue();
end;
...
begin
  ...
  if not boOpened then Exit;
  g_Config.dwGuildWarTime := EditGuildWarTime.Value * 60000{(60 * 1000)};
  ModValue();
end;
...
begin
  ...
  if not boOpened then Exit;
  g_Config.dwSaveHumanRcdTime := EditSaveHumanRcdTime.Value * 60000{(60 * 1000)};
  ModValue();
end;
...
begin
  ...
  if not boOpened then Exit;
  g_Config.dwHumanFreeDelayTime := EditHumanFreeDelayTime.Value * 60000{(60 * 1000)};
  ModValue();
end;
...
{$IF SoftVersion <> VERDEMO}
  ...
  Config.WriteInteger('Setup', 'MakeGhostPlayMosterTime', g_Config.dwMakeGhostPlayMosterTime);//人形怪尸体清理时间 20080418
...
procedure TfrmGameConfig.EditSayMsgFColorChange(Sender: TObject);
var
  btColor: Byte;
begin
  btColor := EditSayMsgFColor.Value;
  LabelSayMsgFColor.Color := GetRGB(btColor);
  if not boOpened then Exit;
  g_Config.btSayMsgFColor := btColor;
  ModValue();
end;

procedure TfrmGameConfig.EditSayeMsgBColorChange(Sender: TObject);
var
  btColor: Byte;
begin
  btColor := EditSayeMsgBColor.Value;
  LabelSayMsgBColor.Color := GetRGB(btColor);
  if not boOpened then Exit;
  g_Config.btSayeMsgBColor := btColor;
  ModValue();
end;
...
{$IF SoftVersion <> VERDEMO}
  ...
  Config.WriteInteger('Setup', 'SayMsgFColor', g_Config.btSayMsgFColor);//前景  千里传音 20080309
  Config.WriteInteger('Setup', 'SayeMsgBColor', g_Config.btSayeMsgBColor);//背景 千里传音 20080309
...
//进入排行的最低等级
procedure TfrmGameConfig.SpinEditLimitMinOrderLevelChange(Sender: TObject);
begin
...
procedure TfrmGameConfig.ButtonAssistantSaveClick(Sender: TObject);
begin
(*{$IF SoftVersion <> VERDEMO}
...
procedure TfrmGameConfig.RadioButtonSdoAssistantClick(Sender: TObject);
begin

end;

//是否保存双倍经验时间 20080412
procedure TfrmGameConfig.CheckBoxSaveExpRateClick(Sender: TObject);
begin
  if not boOpened then Exit;
  g_Config.boSaveExpRate := CheckBoxSaveExpRate.Checked;
  ModValue();
end;
//人形怪尸体清理时间 20080418
procedure TfrmGameConfig.EditMakeGhostPlayMosterTimeChange(
  Sender: TObject);
begin
  if EditMakeGhostPlayMosterTime.Text = '' then begin
    EditMakeGhostPlayMosterTime.Text := '0';
    Exit;
  end;
  if not boOpened then Exit;
  g_Config.dwMakeGhostPlayMosterTime := EditMakeGhostPlayMosterTime.Value * 1000;
  ModValue();
end;
//GM命令错误是否提示 20080602
procedure TfrmGameConfig.CheckBoxGMShowMsgClick(Sender: TObject);
begin
  if not boOpened then Exit;
  g_Config.boGMShowFailMsg := CheckBoxGMShowMsg.Checked;
  ModValue();
end;

procedure TfrmGameConfig.EditKillHumanWeaponUnlockRateChange(
  Sender: TObject);
begin
  if EditKillHumanWeaponUnlockRate.Text = '' then begin
    EditKillHumanWeaponUnlockRate.Text := '0';
    Exit;
  end;
  if not boOpened then Exit;
  g_Config.nKillHumanWeaponUnlockRate := EditKillHumanWeaponUnlockRate.Value;
  ModValue();
end;

//记录人物私聊，行会聊天信息 20081213
procedure TfrmGameConfig.CheckBoxRecordClientMsgClick(Sender: TObject);
begin
  if not boOpened then Exit;
  g_Config.boRecordClientMsg := CheckBoxRecordClientMsg.Checked;
  ModValue();
end;

procedure TfrmGameConfig.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action := caFree;
end;

procedure TfrmGameConfig.FormDestroy(Sender: TObject);
begin
  frmGameConfig := nil;
end;
