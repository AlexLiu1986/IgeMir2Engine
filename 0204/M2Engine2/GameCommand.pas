...
begin
  ...
  try
    ...
    MainOutMessage('{异常} TfrmGameCmd.RefGameMasterCmd Code:'+inttostr(nCode));
  end;
end;
...
//------------------------------------------------------------------------------
  ...
  RefGameMasterCmd(@g_GameCommand.NGLEVEL,//调整人物内功等级 20081221
    '@' + g_GameCommand.NGLEVEL.sCmd + ' 人物名称 内功等级(1-255)',
  ...
  RefGameMasterCmd(@g_GameCommand.RECALLMOBEX,                    //20080122 召唤宝宝
    '@' + g_GameCommand.RECALLMOBEX.sCmd + ' 怪物名称 名称颜色 坐标X 坐标Y',
    '召唤指定怪物为宝宝(支持权限分配)-魔王岭');
...
{  GameCmd := @g_GameCommand.SHOWOPEN;
  ...
  RefGameDebugCmd(GameCmd,
    '@' + GameCmd.sCmd + ' NPC名称 脚本文件名 外形(数字) 属沙城(0,1)',
    '增加NPC');
