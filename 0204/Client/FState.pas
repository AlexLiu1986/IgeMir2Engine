...
type
  ...
  X, Y: Integer);
    ...
    procedure DExpCrystalTopMouseMove(Sender: TObject; Shift: TShiftState; X,
      Y: Integer);
...
procedure TFrmDlg.DExpCrystalTopMouseMove(Sender: TObject; Shift: TShiftState;
  X, Y: Integer);
begin
  //
end;
...
procedure TFrmDlg.DWExpCrystalMouseMove(Sender: TObject; Shift: TShiftState; X, Y: Integer);
begin
  //
end;
...
procedure TFrmDlg.DCrystalExpMouseMove(Sender: TObject; Shift: TShiftState; X,
  Y: Integer);
begin
  //
end;
