...
uses
	Classes, Math, SysUtils, StrUtils, WinTypes, Graphics;
...
function ArrestStringEx (Source, SearchAfter, ArrestBefore: string; var ArrestStr: string): string;
var
   {BufCount, SrcCount,20080722注释 未使用} SrcLen: integer;
   GoodData{, Fin20080722注释 未使用}: Boolean;
   i, n: integer;
begin
